...
import { ArrowLeft, Star, Clock, MapPin, Users, Camera, Eye, Calendar, Phone, Mail, Globe, Award, Heart, Sparkles, TreePine, Search } from 'lucide-react';
import { useCurrency } from '../../contexts/CurrencyContext';

const MikumiDetail: React.FC = () => {
  ...
  const packages = [
    {
      ...
      duration: "1 Day",
      price: "$180/person",
      includes: ["Game drives", "Lunch", "Park fees", "Transport"],
      description: "Perfect day trip from Dar es Salaam",
      popular: true
    },
    {
      ...
      duration: "2 Days",
      price: "$320/person",
      includes: ["Game drives", "Accommodation", "All meals", "Park fees"],
    ...
    },
    {
      ...
      duration: "3 Days",
      price: "$450/person",
      includes: ["Photography guide", "Premium accommodation", "All meals", "Equipment tips"],
      description: "Capture stunning wildlife photographs",
      popular: false
    }
  ];

  const activities = [
    { icon: <Eye className="w-6 h-6" />, name: "Game Drives", description: "Spot elephants, lions, and hippos", gradient: "from-emerald-500 to-emerald-600" },
    { icon: <Camera className="w-6 h-6" />, name: "Photography", description: "Capture baobab trees and wildlife", gradient: "from-blue-500 to-blue-600" },
    { icon: <Search className="w-6 h-6" />, name: "Bird Watching", description: "Over 400 bird species", gradient: "from-amber-500 to-amber-600" },
    { icon: <TreePine className="w-6 h-6" />, name: "Nature Walks", description: "Guided walking safaris", gradient: "from-purple-500 to-purple-600" }
  ];
        ...
        <div className="container-mobile relative z-10 h-full flex items-center">
          <div className="text-white max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-600/20 backdrop-blur-sm border border-emerald-400/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-emerald-200 text-sm font-medium">Southern Circuit Gem</span>
            </div>
            ...
            <p className="text-lg sm:text-xl lg:text-2xl mb-8 max-w-3xl leading-relaxed text-white/90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Tanzania's fourth-largest national park, famous for its open horizons and abundant wildlife just hours from Dar es Salaam
            </p>
          ...
          <div className="lg:col-span-2 space-y-12 sm:space-y-16">
            ...
            <section className="animate-fade-in-up">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
                <p className="mb-4">
                  Mikumi National Park covers 3,230 square kilometers and is the most accessible park from Dar es Salaam, 
                  making it perfect for day trips and weekend getaways. The park is characterized by the Mkata Floodplain, 
                  which is dotted with baobab trees and provides excellent wildlife viewing opportunities year-round.
                </p>
                <p>
                  The park is home to large populations of elephants, giraffes, zebras, wildebeest, and over 400 bird species. 
                  Lions and leopards are also present, though less frequently seen. The landscape varies from open grasslands 
                  to miombo woodlands, creating diverse habitats that support a rich variety of wildlife.
                </p>
              </div>
            </section>
                  ...
                  >
                    ...
                    <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap z-20 pointer-events-none px-4 py-3">
                      <div className="text-center">
                        <h4 className="font-semibold text-gray-900 text-sm mb-1">Mikumi National Park</h4>
                        <div className="flex items-center justify-center space-x-1">
                          <span className="text-orange-400 text-lg">4.7</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="card-classic p-6 border-l-4 border-emerald-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Best wildlife viewing with animals gathering at water sources
                  </p>
                </div>
                <div className="card-classic p-6 border-l-4 border-blue-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Lush landscapes, bird watching, and fewer crowds
                  </p>
                </div>
              </div>
            </section>
