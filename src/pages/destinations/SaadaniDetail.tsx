...
import { ArrowLeft, Star, Clock, MapPin, Users, Camera, Eye, Calendar, Phone, Mail, Globe, Award, Heart, Sparkles, Waves, Trees } from 'lucide-react';
import { useCurrency } from '../../contexts/CurrencyContext';

const SaadaniDetail: React.FC = () => {
  ...
  const packages = [
    {
      ...
      duration: "1 Day",
      price: "$160/person",
      includes: ["Game drive", "Beach time", "Lunch", "Park fees"],
      description: "Experience wildlife and the Indian Ocean in a day",
      popular: true
    },
    {
      ...
      duration: "2 Days",
      price: "$320/person",
      includes: ["Boat ride", "Accommodation", "All meals", "Park fees"],
      description: "Explore mangroves and coastal savannah",
      popular: false
    },
    {
      name: "Coastal Safari Escape",
      duration: "3 Days",
      price: "$450/person",
      includes: ["Game drives", "Beach stay", "All meals", "Boat ride"],
      description: "Relaxed coastal safari with ocean views",
      popular: false
    }
  ];

  const activities = [
    { icon: <Waves className="w-6 h-6" />, name: "Beach Time", description: "Safari where the bush meets the beach", gradient: "from-emerald-500 to-emerald-600" },
    { icon: <Eye className="w-6 h-6" />, name: "Game Drives", description: "See giraffe, buffalo, and antelope", gradient: "from-blue-500 to-blue-600" },
    { icon: <Trees className="w-6 h-6" />, name: "Mangrove Cruise", description: "Boat ride through mangrove channels", gradient: "from-amber-500 to-amber-600" },
    { icon: <Camera className="w-6 h-6" />, name: "Photography", description: "Unique coastal wildlife scenes", gradient: "from-purple-500 to-purple-600" }
  ];

  const gallery = [
    "https://images.unsplash.com/photo-1505761671935-60b3a7427bad?w=800&auto=format&fit=crop&q=80",
    "https://images.unsplash.com/photo-1505764706515-aa95265c5abc?w=800&auto=format&fit=crop&q=80",
    "https://images.unsplash.com/photo-1519608425089-7f3bfa76d2a0?w=800&auto=format&fit=crop&q=80",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-amber-50">
      ...
      <div className="relative h-[70vh] sm:h-[80vh] lg:h-[90vh] overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1505764706515-aa95265c5abc?w=1920&auto=format&fit=crop&q=80"
        ...
        <div className="container-mobile relative z-10 h-full flex items-center">
          <div className="text-white max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-600/20 backdrop-blur-sm border border-emerald-400/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-emerald-200 text-sm font-medium">Where Beach Meets Bush</span>
            </div>
            ...
            <p className="text-lg sm:text-xl lg:text-2xl mb-8 max-w-3xl leading-relaxed text-white/90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Tanzania's only coastal national park, offering a unique blend of wildlife viewing and Indian Ocean beaches
            </p>
          ...
          <div className="lg:col-span-2 space-y-12 sm:space-y-16">
            ...
            <section className="animate-fade-in-up">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
                <p className="mb-4">
                  Saadani National Park uniquely combines coastal ecosystems with classic savannah, where wildlife roams 
                  right up to the Indian Ocean. Palm-fringed beaches, mangrove forests, and river systems create a rich 
                  mosaic of habitats.
                </p>
                <p>
                  Enjoy game drives, beach relaxation, and boat trips through mangrove channels. Common sightings include 
                  giraffe, waterbuck, buffalo, and abundant birdlife, with the chance to spot dolphins offshore.
                </p>
              </div>
            </section>
                  ...
                  >
                    ...
                    <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap z-20 pointer-events-none px-4 py-3">
                      <div className="text-center">
                        <h4 className="font-semibold text-gray-900 text-sm mb-1">Saadani National Park</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="card-classic p-6 border-l-4 border-emerald-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Best beach weather and easier wildlife viewing
                  </p>
                </div>
                <div className="card-classic p-6 border-l-4 border-blue-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Lush scenery, great for birding and mangrove cruises
                  </p>
                </div>
              </div>
            </section>
