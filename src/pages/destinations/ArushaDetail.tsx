  ...
  const packages = [
    {
      ...
      duration: "1 Day",
      price: "$180/person",
      includes: ["Game drive", "Lunch", "Park fees", "Transport"],
      description: "Perfect day trip from Arusha city",
      popular: true
    },
    {
      name: "Canoe & Wildlife",
      duration: "2 Days",
      price: "$320/person",
      includes: ["Canoe safari", "Game drives", "Accommodation", "All meals"],
      description: "Unique canoe experience on Momella Lakes",
      popular: false
    },
    {
      ...
      duration: "4 Days",
      price: "$450/person",
      includes: ["Guided trek", "Camping", "All meals", "Porter service"],
      description: "Climb Tanzania's second highest mountain",
      popular: false
    }
  ];

  const activities = [
    { icon: <Eye className="w-6 h-6" />, name: "Game Drives", description: "See giraffes, zebras, and flamingos", gradient: "from-emerald-500 to-emerald-600" },
    { icon: <Mountain className="w-6 h-6" />, name: "Mount Meru Trek", description: "Climb the spectacular volcanic peak", gradient: "from-blue-500 to-blue-600" },
    { icon: <Users className="w-6 h-6" />, name: "Canoe Safari", description: "Paddle through Momella Lakes", gradient: "from-amber-500 to-amber-600" },
    { icon: <Camera className="w-6 h-6" />, name: "Photography", description: "Capture stunning mountain and lake views", gradient: "from-purple-500 to-purple-600" }
  ];
        ...
        <div className="container-mobile relative z-10 h-full flex items-center">
          <div className="text-white max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-600/20 backdrop-blur-sm border border-emerald-400/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-emerald-200 text-sm font-medium">Gateway to Northern Circuit</span>
            </div>
            ...
            <p className="text-lg sm:text-xl lg:text-2xl mb-8 max-w-3xl leading-relaxed text-white/90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              A compact park offering incredible diversity from alkaline lakes to montane forests, crowned by Mount Meru
            </p>
          ...
          <div className="lg:col-span-2 space-y-12 sm:space-y-16">
            ...
            <section className="animate-fade-in-up">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
                <p className="mb-4">
                  Arusha National Park is a gem of diversity, encompassing the slopes of Mount Meru, alkaline Momella Lakes, 
                  and the Ngurdoto Crater. Despite its compact size, it offers an incredible variety of landscapes and wildlife.
                </p>
                <p>
                  The park is famous for its large giraffe herds, colorful flamingo populations, and unique canoe safaris. 
                  It's also the starting point for Mount Meru treks, offering spectacular views of Kilimanjaro.
                </p>
              </div>
            </section>
                  ...
                  >
                    ...
                    <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap z-20 pointer-events-none px-4 py-3">
                      <div className="text-center">
                        <h4 className="font-semibold text-gray-900 text-sm mb-1">Arusha National Park</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="card-classic p-6 border-l-4 border-emerald-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Perfect for Mount Meru treks and clear mountain views
                  </p>
                </div>
                <div className="card-classic p-6 border-l-4 border-blue-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Great for flamingo viewing and lush forest walks
                  </p>
                </div>
              </div>
            </section>
