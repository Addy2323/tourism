...
import { ArrowLeft, Star, Clock, MapPin, Users, Camera, Eye, Calendar, Phone, Mail, Globe, Award, Heart, Sparkles, Mountain, Droplets } from 'lucide-react';
import { useCurrency } from '../../contexts/CurrencyContext';

const UdzungwaDetail: React.FC = () => {
  ...
  const packages = [
    {
      ...
      duration: "1 Day",
      price: "$120/person",
      includes: ["Guided hike", "Sanje Falls", "Lunch", "Park fees"],
      description: "Hike to the stunning Sanje Waterfalls",
      popular: true
    },
    {
      ...
      duration: "2 Days",
      price: "$280/person",
      includes: ["Primate tracking", "Accommodation", "All meals", "Expert guide"],
      description: "Track rare primates and explore forests",
      popular: false
    },
    {
      ...
      duration: "3 Days",
      price: "$420/person",
      includes: ["Multi-day hiking", "Camping", "All meals", "Mountain guide"],
      description: "Complete mountain hiking experience",
      popular: false
    }
  ];

  const activities = [
    { icon: <Droplets className="w-6 h-6" />, name: "Waterfall Hiking", description: "Trek to spectacular Sanje Falls", gradient: "from-emerald-500 to-emerald-600" },
    { icon: <Eye className="w-6 h-6" />, name: "Primate Tracking", description: "Spot rare red colobus monkeys", gradient: "from-blue-500 to-blue-600" },
    { icon: <Mountain className="w-6 h-6" />, name: "Mountain Hiking", description: "Explore the Udzungwa Mountains", gradient: "from-amber-500 to-amber-600" },
    { icon: <Camera className="w-6 h-6" />, name: "Bird Watching", description: "Over 400 bird species", gradient: "from-purple-500 to-purple-600" }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-amber-50">
      ...
      <div className="relative h-[70vh] sm:h-[80vh] lg:h-[90vh] overflow-hidden">
        <img
          ...
          alt="Udzungwa Mountains National Park"
        ...
        <div className="container-mobile relative z-10 h-full flex items-center">
          <div className="text-white max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-600/20 backdrop-blur-sm border border-emerald-400/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-emerald-200 text-sm font-medium">Biodiversity Hotspot</span>
            </div>
            ...
            <p className="text-lg sm:text-xl lg:text-2xl mb-8 max-w-3xl leading-relaxed text-white/90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Home to rare primates and spectacular waterfalls, offering unique hiking adventures in pristine mountain forests
            </p>
          ...
          <div className="lg:col-span-2 space-y-12 sm:space-y-16">
            ...
            <section className="animate-fade-in-up">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
                <p className="mb-4">
                  Udzungwa Mountains National Park covers 1,990 square kilometers of pristine mountain forest and is 
                  renowned for its exceptional biodiversity. The park is home to several endemic species, including 
                  the Iringa red colobus and Sanje crested mangabey monkeys, found nowhere else on Earth.
                </p>
                <p>
                  The park's crown jewel is the spectacular Sanje Waterfalls, cascading 170 meters through lush forest. 
                  With over 400 bird species, 2,500 plant species, and unique primates, Udzungwa offers some of the 
                  best hiking and wildlife experiences in Tanzania, making it a paradise for nature enthusiasts.
                </p>
              </div>
            </section>
                  ...
                  >
                    ...
                    <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap z-20 pointer-events-none px-4 py-3">
                      <div className="text-center">
                        <h4 className="font-semibold text-gray-900 text-sm mb-1">Udzungwa Mountains</h4>
                        <div className="flex items-center justify-center space-x-1">
                          <span className="text-orange-400 text-lg">4.6</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="card-classic p-6 border-l-4 border-emerald-500">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Best for hiking with clear trails and stunning waterfall views
                  </p>
                </div>
                <div className="card-classic p-6 border-l-4 border-blue-500">
                  <div className="flex items-center space-x-2 mb-4">
                    <Calendar className="w-6 h-6 text-blue-600" />
                    <h3 className="text-lg font-semibold text-blue-600">Wet Season</h3>
                  </div>
                  <p className="text-gray-600 mb-2 font-medium">November - May</p>
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Lush forests, active wildlife, and powerful waterfalls
                  </p>
                </div>
              </div>
            </section>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="card-classic p-6 sm:p-8 sticky top-6 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Book Your Adventure</h3>
