    ...
    <section id="impact" className="scroll-mt-36">
      ...
      <div className="bg-emerald-600 pt-28 lg:pt-36 py-16 sm:py-20 lg:py-24">
        <div className="container-mobile text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-6 animate-fade-in-up text-balance" style={{ animationDelay: '0.1s' }}>
            Our{" "}
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-4xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
      ...
      <div className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-emerald-50 via-blue-50 to-amber-50">
